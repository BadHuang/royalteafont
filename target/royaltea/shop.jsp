...
<!DOCTYPE html>
<html>
	<c:set var="localhost" value="127.0.0.1"/>
	<head lang="en">
		<meta charset="utf-8" />
	...
	<div data-role="page" id="pageone">
			...
			<nav class="navbar navbar-expand-lg main-navbar">
				...
				<button class="btn btn-secondary" type="submit" style="background-color:#EDEDED;border-color: #EDEDED;font-size: 20px; "><i class="ion ion-search" style="color: #4e555b"></i></button>
		...
		<footer class="fixed-bottom">
			<div class="shoppingcar" onclick="location='car'">
				...
				<button class="btn btn-secondary" type="submit" style="background-color:#EDEDED;border-color: #EDEDED;font-size: 20px;float: right;margin-top: 6px;margin-right: 5px;"><font color="#4e555b">结算</font></button>
			</div>
		</footer>
	</div>
	</div>
			...
			<div class="modal-content">
				<form action="emp-update1" class="form-horizontal" method="post">
					...
					<table>
						...
						<span style="color: black;font-size: 2em;">总价：&nbsp;¥<span id="total1">${cartotal }</span></span>&nbsp;
						<c:if test="${cartotal==cardtotal }">
						<span style="color: #9F9F9F;text-decoration:line-through;font-size: 1.5em;display: none;">¥<span id="dtotal1">${cardtotal }</span></span>
						</c:if>
						<c:if test="${cartotal!=cardtotal }">
						<span style="color: #9F9F9F;text-decoration:line-through;font-size: 1.5em;display: inline;">¥<span id="dtotal1">${cardtotal }</span></span>
						</c:if>
					</div>
	...
	<script>
		...
		function showFood(obj){
			...
			if(num!='0'){
				...
				$('#num').prev().css("visibility","visible");
			}
